...
function LineageSelectBuilder({currentCharacter, updateCharacter}: lineageSelectProps){
    ...
    return(
        <div className={currentCharacter.characterLineage? "border-t-emerald-600 border-t-8 px-10" :"border-t-amber-800 border-t-8 px-10"}>
            <SelectFromCards optionType={option_type.lineage} options={lineages} popoutInner={Lineage} optionsDescription={description} updateCharacter={updateCharacter} currentCharacter={currentCharacter}/>
        </div>
