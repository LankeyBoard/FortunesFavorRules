...
const CopyLink =({target}: {target: string}) => {
    ...
    const size = '1.5rem'
    return(
      <Link href={linkPath} className="" onClick={()=> {navigator.clipboard.writeText(origin+linkPath);}}>
      <svg className="fill-teal-500 dark:hover:fill-teal-300 hover:fill-teal-700 inline" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
       width={size} height={size} viewBox="0 0 72 72" enableBackground="new 0 0 72 72">
  <g>
      <g>
