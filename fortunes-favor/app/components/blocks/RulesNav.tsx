        ...
        <div className={menuStyle}>
            ...
            <Tooltip message={menuVisible? "Hide Menu" : "Show Menu"}>           
                <div className={"flex-left z-50"}>
                    <div className={menuVisible ? "-rotate-90 w-auto h-auto m-2" : "rotate-90 w-auto h-auto m-2"}>
                        <button aria-controls="sidebar-multi-level-sidebar" type="button" onClick={handleMenuHideButton} className="items-center p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
