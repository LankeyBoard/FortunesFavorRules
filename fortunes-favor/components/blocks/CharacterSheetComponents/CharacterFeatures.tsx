                ...
                >
                  <span className="w-6 h-6">
                    <svg
                      ...
                      className="fill-slate-900 stroke-slate-900 dark:fill-slate-100 dark:stroke-slate-100 w-6 h-6 hover:stroke-slate-700 hover:dark:stroke-slate-300 hover:fill-slate-700 hover:dark:fill-slate-300"
                    >
