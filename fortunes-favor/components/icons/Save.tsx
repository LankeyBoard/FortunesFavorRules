    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g>
          ...
          <rect x="173.564" y="39.039" width="24.588" height="69.604"></rect>{" "}
          <rect x="59.489" y="174.643" width="171.021" height="8.195"></rect>{" "}
          <rect x="59.489" y="215.62" width="171.021" height="8.195"></rect>{" "}
        </g>{" "}
      </g>
    </svg>
  );
